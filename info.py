...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002055701287').split()] #Channel id for auto indexing ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://loki48:aaaa11@loki48.v9x0b9m.mongodb.net/?retryWrites=true&w=majority&appName=loki48")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/hd_movies48')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/https://t.me/hd_movies488/36') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ʜᴘ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002028169131')) #Log channel id ( make sure bot is admin )
...
URL = "https://loki48-loki48888.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://loki48-loki48888.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://loki48-loki48888.koyeb.app/".format(FQDN)
else:
    URL = "https://loki48-loki48888.koyeb.app/".format(FQDN)
